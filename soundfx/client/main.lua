...
------
-- RegisterNetEvent TORNADO_CL:Sound:PlayOnOne
--
...
------
RegisterNetEvent('TORNADO_CL:Sound:PlayOnOne')
AddEventHandler('TORNADO_CL:Sound:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
-- RegisterNetEvent TORNADO_CL:Sound:PlayOnAll
--
-- @param soundFile    - The name of the soundfile within the client/html/sounds/ folder.
--                     - Can also specify a folder/sound file.
-- @param soundVolume  - The volume at which the soundFile should be played. Nil or don't
...
------
RegisterNetEvent('TORNADO_CL:Sound:PlayOnAll')
AddEventHandler('TORNADO_CL:Sound:PlayOnAll', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSound',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
...
------
-- RegisterNetEvent TORNADO_CL:Sound:PlayWithinDistance
--
...
------
RegisterNetEvent('TORNADO_CL:Sound:PlayWithinDistance')
AddEventHandler('TORNADO_CL:Sound:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
